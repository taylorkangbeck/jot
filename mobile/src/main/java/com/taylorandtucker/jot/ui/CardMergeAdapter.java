 ...
 *
 * largely borrowed from http://stackoverflow.com/questions/7964259/android-attaching-multiple-adapters-to-one-adapter
 *
 ...
 *
 */
public class CardMergeAdapter extends BaseAdapter implements SectionIndexer {
    protected ArrayList<ListAdapter> pieces = new ArrayList<ListAdapter>();
    protected String noItemsText;

    public CardMergeAdapter() {
        super();
    }
